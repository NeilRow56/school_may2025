    ...
    <div className='flex flex-col gap-4 p-4 md:flex-row'>
      ...
      <div className='flex w-full flex-col gap-8 bg-yellow-50 lg:w-2/3'>
        ...
        <div className='flex flex-col gap-4 lg:flex-row'>
          {/* COUNT CHART */}
          <div className='h-[450px] w-full lg:w-1/3'>COUNT CHART</div>
          {/* ATTENDANCE CHART */}
          <div className='h-[450px] w-full lg:w-2/3'>ATTENDANCE CHART</div>
        </div>
        {/* BOTTOM CHART */}
        <div className='h-[500px] w-full'>FINANCE CHART</div>
      </div>
      {/* RIGHT */}
